...
public class P02_LandingPage {
    ...
    public P02_LandingPage addAllProductsToCart() {
        ...
        LogsUtils.logInfo("Number Of All Products: " + allProducts.size());
    ...
    public String getNumberOfProductsOnCartIcon() {
        try {
            LogsUtils.logInfo("NumberOfProductsOnCartIcon: " + Utility.getText(driver, numberOfProductsOnCartIcon));
    ...
    public String getNumberOfSelectedProducts() {
        try {
            ...
            LogsUtils.logInfo("NumberOfSelectedProducts: " + selectedProducts.size());
    ...
    public P02_LandingPage addRandomProducts(int numberOfProductsNeeded, int totalNumberOfProducts) {
        ...
        for (int random : randomNumbers) {
            LogsUtils.logInfo("random Number: " + random);
